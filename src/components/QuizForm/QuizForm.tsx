...
import { useUpdateScoreMutation } from "@/redux/api/score";
...
const QuizForm = ({ quiz }: any) => {
  const { userId } = getUserDataFromLC() as any;
  ...
  const { title, options, answer } = questions[activeQuestion];
  ...
  return (
    <div className=" my-14 ">
      <div>
        {!showResult ? (
          <div className="group cursor pt-[70px] overflow-hidden rounded-2xl bg-white shadow-xl duration-200  p-3 border relative ">
            <svg
            ...
            <div>
              <h3 className="text-xl py-5 shadow shadow-blue-500 rounded-xl text-center">
                <span className="font-semibold">
                  {" "}
                  {questions[activeQuestion].title}
                </span>
              </h3>
              <div className="grid grid-col-1 lg:grid-cols-2 gap-3 items-center my-[30px]">
                  ...
                  <li
                    ...
                    className={`${
                      selectedAnswerIndex === idx
                        ...
                        : "li-hover"
                    } w-full p-3 rounded-lg flex items-center gap-5 shadow-lg cursor-pointer border border-gray-200 hover:border-blue-600`}
                  >
                    <span className=" bg-gray-700 ml-1 text-white rounded-lg py-2 px-3 text-center">
                      {idx + 1}{" "}
                    </span>
                    <span>{answer}</span>
                  </li>
              ...
              {checked ? (
                ...
                <Button
                  onClick={nextQuestion}
                  disabled
                  className="bg-blue-600 hover:bg-blue-900 w-full !text-white"
                >
                  {activeQuestion === questions.length - 1 ? "Finish" : "Next"}
                </Button>
              )}
              ...
              <div className="flex items-center justify-center ">
                <p className="text-gray-600 text-xl pt-5 border-t-3">
                  {activeQuestion + 1}
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="flex flex-col gap-2 col-span-3 p-4 text-center text-xl bg-blue-600 text-white shadow-inner rounded-lg ">
