              ...
              <div className="border-t border-gray-200 my-1  w-full">
                <div className=" space-y-1">
                  <Link href="/login" className="block md:hidden w-full">
                    <span className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-400 w-full">
                      Login
                    </span>
                  </Link>
                </div>
